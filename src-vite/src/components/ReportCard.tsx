...
import { SEVERITY_BG, STATUS_BG, CATEGORY_ICON, relativeTime } from '../utils'
...
export default function ReportCard({ report, onClose, expanded, onClick }: Props) {
  return (
    <div
      onClick={onClick}
      className={`bg-[#1a1d2e] border border-[#2a2d3e] rounded-2xl overflow-hidden shadow-2xl card-hover ${onClick ? 'cursor-pointer' : ''}`}
    >
